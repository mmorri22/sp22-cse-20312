...
# Spring 2022 - Data Structures - Programming Challenge 06 - Grading Script
#
...
INTRO_MESSAGE="Grading script for Spring 2022 - Programming Challenge 06"
...
if test -f "objects/PC06.o" || test -f "objects/lru_cache.o"; then
...
echo "-----------------------------" >> $SCRIPT_OUT
echo "" >> $SCRIPT_OUT
echo "PC06 Standards Grade Portion for $STUDENT_NAME ($STUDENT_ID): $STUDENT_GRADE / $TOTAL " >> $SCRIPT_OUT
echo "PC06 Standards Grade Portion for $STUDENT_NAME ($STUDENT_ID): $STUDENT_GRADE / $TOTAL "
