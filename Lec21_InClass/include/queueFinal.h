...
class queue {
     ...
     * *******************************************/       	
        ...
        bool operator< (const queue<T>& comp){
            return this->peek() < comp.out.top();
        }
        ...
        friend std::ostream& operator<< (std::ostream& stream, const queue<T>* theQueue){
            
            stream << &(theQueue->out.top()) << " ";
