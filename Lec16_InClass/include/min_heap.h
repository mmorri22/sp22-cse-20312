 ...
 *
 * This head file contains a simplified version
 * of a Minimum Heap using C++ structs and templates
 * for Lecture 16 for CSE 20312 Data Structures
 *
 * Concepts such as copy constructions, assignment operators
 * and friend operators are not included because the students
 * will cover those advanced details in Lecture 25
 *****************************************************/
