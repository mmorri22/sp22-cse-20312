...
# Spring 2022 - Data Structures - Programming Challenge 04 - Grading Script
#
...
INTRO_MESSAGE="Grading script for Spring 2022 - Programming Challenge 04"
...
if test -f "objects/PC04.o" || test -f "objects/game.o"; then
